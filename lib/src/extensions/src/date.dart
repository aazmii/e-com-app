...
extension DateUtils on DateTime {
  ...
  String formattedDate() => DateFormat('MMMMd').format(this);

  String formattedTime() => DateFormat.jm().format(this);
  String formattedDateTime() =>
      '${DateFormat('MMMMd').format(this)}, ${DateFormat.jm().format(this)}';

  String formatted() => DateFormat.jm().format(this);

  String fullDate() => DateFormat.yMMMMd().format(this);
  String fullTime() => DateFormat.jm().format(this);
